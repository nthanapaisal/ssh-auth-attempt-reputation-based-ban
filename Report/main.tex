...
The test was conducted over a period from \texttt{2026-04-28 15:33:33 UTC} to \texttt{2026-04-30 08:36:55 UTC} (approximately 2 days and 5 hours). During this time:
\begin{itemize}
...
These results indicate that the firewall rules significantly reduced the load on the SSH service by filtering the majority of malicious traffic upstream. Additionally, early blocking of most unique IPs demonstrates the system's effectiveness at mitigating repeated intrusion attempts with minimal exposure.
